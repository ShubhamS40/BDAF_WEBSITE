...
export default function TopBar() {
  return (
    <div className="bg-black text-white py-2 border-b border-gray-800 overflow-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">

        {/* MOBILE VIEW */}
        <div className="flex md:hidden items-center justify-between gap-3 text-[11px]">

          {/* Mail */}
          <a
            href="mailto:support@bdaf.in"
          ...
          >
            ...
            <span>+91 87440 30904</span>
          </a>

          {/* WhatsApp */}
          <a
            href="https://wa.me/918744030904"
            target="_blank"
